...
\begin{center}
\includegraphics[scale=.25]{./sad-data/dissertation/BeetleRAD.png}\\
\end{center}
\end{frame}
...
\frametitle{Let's begin with an example...}
\begin{center}
\includegraphics[scale=.25]{./sad-data/dissertation/BeetleRAD_w_graph.png}\\
\end{center}
\end{frame}
...
\hline
 ...
 Reptilia, compiled &Reptilia &Public &129\\
