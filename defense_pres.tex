...
\normalsize Search for general patterns \& processes.\\
\begin{center}
\includegraphics[scale=.35]{./sad-data/dissertation/PatternProcess_example.png}
\end{center}
\note{
\begin{itemize}
\item Data intensive.
...
\end{itemize}
\includegraphics[scale=.5]{./sad-data/dissertation/generichollowcurves.png}\\
\begin{itemize}
...
\begin{center}
\includegraphics[scale=.27]{./sad-data/dissertation/Wrangling.png}
\end{center}
\begin{tiny}
Cavitt 2000.
\end{tiny}
...
\begin{center}
\includegraphics[scale=.25]{./sad-data/dissertation/Connolly2014AB.png}
\end{center}
\note{
\begin{small}
\begin{itemize}
