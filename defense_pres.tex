...
\begin{center}
\includegraphics[scale=.05]{../Miscellaneous/Pictures/Maps/TheMapsCoarse.png}
\end{center}
\end{frame}
...
\frametitle{Signal \& Noise}
\begin{center}
\includegraphics[scale=.05]{../Miscellaneous/Pictures/Maps/TheMapsMiddle.png}
\end{center}
\end{frame}
...
\frametitle{Signal \& Noise}
\begin{center}
\includegraphics[scale=.2]{../Miscellaneous/Pictures/Maps/TheMaps.png}
\end{center}
\end{frame}
